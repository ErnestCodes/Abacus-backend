...
function googleOauthHandler(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const accessToken = (0, jwt_utils_1.signJwt)(Object.assign(Object.assign({}, user.toJSON()), { session: session._id }), {
                expiresIn: config_1.default.get("accessTokenTtl"), // 15 minutes
            });
            //   create a refresh token
            const refreshToken = (0, jwt_utils_1.signJwt)(Object.assign(Object.assign({}, user.toJSON()), { session: session._id }), {
